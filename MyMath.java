...
public class MyMath
{
   ...
   */
  public boolean mersenneTrue (int n){
  ...
  /*
   * gives the perfect number using mersenne primes
   */

  public long perfectNum (int n){
	  return (long) (Math.pow(2,(n-1))*(Math.pow(2,n)-1));
  }
  
  /* runs a program that gets the perfect numbers 
   * 
   */
  public void giveNum (){
